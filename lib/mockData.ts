...
export const mockProjects: Project[] = [
  {
    ...
    description:
      "A comprehensive study of modern optimization algorithms in deep learning.",
    status: "submitted",
    researcherId: "user-2",
    advisorId: "user-6",
  ...
  },
  {
    ...
    description:
      "Methods for ensuring data privacy in distributed cloud environments.",
    status: "approved",
    researcherId: "user-2",
    advisorId: "user-6",
  ...
  },
  {
    ...
    description:
      "Novel approaches to designing efficient neural network architectures.",
    status: "submitted",
    researcherId: "user-3",
    advisorId: "user-7",
  ...
  },
  {
    ...
    description:
      "Investigating novel battery technologies for sustainable energy storage.",
    status: "rejected",
    researcherId: "user-3",
...
export const mockFeedbacks: Feedback[] = [
  {
    ...
    score: 92,
    comments:
      "Excellent work on the cloud privacy framework. Well-researched and innovative.",
...
export const mockNotifications: Notification[] = [
  {
    ...
    message:
      'Project "Machine Learning Optimization Techniques" requires your review',
    type: "info",
    read: false,
...
export const getProjectsByUserId = (
  ...
  if (role === "advisor") {
    return mockProjects.filter((p) => p.advisorId === userId);
  }
  return mockProjects; // coordinator sees all
};

export const getProposalAuditTrail = (
  proposalId: string,
): AuditTrailEntry[] => {
