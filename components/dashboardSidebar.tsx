      ...
      <Card className="border border-red-500 bg-red-50 shadow-sm rounded-xl">
        <CardContent className="p-4 space-y-2">
          ...
          <p className="text-sm text-red-700">
            A procurement request for <strong>750,000 ETB</strong> in Project
            ASTU-R-04 exceeds the standard threshold.
          </p>
      ...
      <Card className="border border-gray-200 bg-white shadow-sm rounded-xl">
        <CardContent className="p-4 space-y-2">
          ...
          <p className="text-gray-600 text-sm">
            The Q3 progress report for <strong>Smart Grid Optimization</strong>{" "}
            is due in 3 days.
          </p>
        </CardContent>
      </Card>
